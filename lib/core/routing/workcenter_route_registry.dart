...
class WorkcenterRouteRegistry {
  static const Map<String, String> _mappings = {
    ...
    'STOCK': '${AppRoutes.inventory}?section=stock',
    'GOODS_RECEIPT': '${AppRoutes.inventory}?section=goods-receipts',
    'GOODS-RECEIPT': '${AppRoutes.inventory}?section=goods-receipts',
    'PUTAWAY': '${AppRoutes.inventory}?section=putaways',
    'STOCK_ON_HAND': '${AppRoutes.inventory}?section=stock',
    'STOCK-ON-HAND': '${AppRoutes.inventory}?section=stock',
    'STOCK_MOVEMENT': '${AppRoutes.inventory}?section=movements',
    'STOCK-MOVEMENT': '${AppRoutes.inventory}?section=movements',
    'STOCK_MOVEMENTS': '${AppRoutes.inventory}?section=movements',
    'STOCK-MOVEMENTS': '${AppRoutes.inventory}?section=movements',
    'INVENTORY_AUDIT': '${AppRoutes.inventory}?section=audit',
    'INVENTORY-AUDIT': '${AppRoutes.inventory}?section=audit',
    'STOCK_AUDIT': '${AppRoutes.inventory}?section=audit',
    'STOCK-AUDIT': '${AppRoutes.inventory}?section=audit',
    'INVENTORY_SETUP': '${AppRoutes.inventory}?section=setup',
    'INVENTORY-SETUP': '${AppRoutes.inventory}?section=setup',
    'WAREHOUSE_SETUP': '${AppRoutes.inventory}?section=setup',
    'WAREHOUSE-SETUP': '${AppRoutes.inventory}?section=setup',
    'SALES_ORDER': '${AppRoutes.inventory}?section=sales-orders',
    'QUOTATION': '${AppRoutes.inventory}?section=quotations',
    'QUOTATIONS': '${AppRoutes.inventory}?section=quotations',
    'QUOTE': '${AppRoutes.inventory}?section=quotations',
    'QUOTES': '${AppRoutes.inventory}?section=quotations',
    'PURCHASE_ORDER': '${AppRoutes.inventory}?section=purchase-orders',
    'PURCHASE-ORDER': '${AppRoutes.inventory}?section=purchase-orders',
    'PURCHASE_ORDERS': '${AppRoutes.inventory}?section=purchase-orders',
    'PURCHASE-ORDERS': '${AppRoutes.inventory}?section=purchase-orders',
    'SALES-ORDER': '${AppRoutes.inventory}?section=sales-orders',
