...
class WorkcenterRouteRegistry {
  static const Map<String, String> _mappings = {
    ...
    'LEGAL_DASHBOARD': AppRoutes.legal,
    'LEGAL_INTAKE': AppRoutes.legalIntake,
    'LEGAL_CONFLICT_CHECKS': AppRoutes.legalConflicts,
    'LEGAL_MATTERS': AppRoutes.cases,
    'LEGAL_LITIGATION': AppRoutes.legalLitigation,
    'LEGAL_CONVEYANCING': AppRoutes.legalConveyancing,
    'LEGAL_ESTATES': AppRoutes.legalEstates,
    'LEGAL_COMMERCIAL': AppRoutes.legalCommercial,
    'LEGAL_FAMILY': AppRoutes.legalFamily,
    'LEGAL_LABOUR': AppRoutes.legalLabour,
    'LEGAL_CRIMINAL': AppRoutes.legalCriminal,
    'LEGAL_CALENDAR': AppRoutes.legalCalendar,
    'LEGAL_TASKS': AppRoutes.legalTasks,
    'LEGAL_DOCUMENTS': AppRoutes.legalDocuments,
    'LEGAL_CORRESPONDENCE': AppRoutes.legalCorrespondence,
    'LEGAL_TIME': AppRoutes.legalTime,
    'LEGAL_DISBURSEMENTS': AppRoutes.legalDisbursements,
    'LEGAL_BILLING': AppRoutes.legalBilling,
    'LEGAL_TRUST': AppRoutes.legalTrust,
    'LEGAL_TRUST_PAYMENTS': AppRoutes.legalTrustPayments,
    'LEGAL_TRUST_RECONCILIATION': AppRoutes.legalTrustReconciliation,
    'LEGAL_APPROVALS': AppRoutes.approvals,
    'LEGAL_REPORTS': AppRoutes.legalReports,
    'LEGAL_ADMINISTRATION': AppRoutes.legalAdministration,
    ...
    'MANAGEMENT_NEW_MEMBERSHIPS_PER_MONTH_REPORT':
        '/reports?report=new-memberships-per-month',
    'MANAGEMENT_APPROVAL_REQUESTS_PER_MONTH_REPORT':
        '/reports?report=approval-requests-per-month',
    'MANAGEMENT_FUNERAL_SERVICES_PER_MONTH_REPORT':
        '/reports?report=funeral-services-per-month',
    'MANAGEMENT_GROUP_SOCIETIES_TOTAL_REPORT':
        '/reports?report=group-societies-total',
    'MANAGEMENT_GROUP_SOCIETY_BALANCES_REPORT':
        '/reports?report=group-society-balances',
    'MANAGEMENT_CONSOLIDATED_CUSTOMER_BALANCES_REPORT':
