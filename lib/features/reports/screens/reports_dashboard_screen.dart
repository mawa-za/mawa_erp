...
class _ReportsDashboardScreenState extends State<ReportsDashboardScreen> {
  static const _reports = <_ReportDefinition>[
    ...
    _ReportDefinition(key:'new-memberships-per-month',workcenterId:'management-new-memberships-per-month-report',title:'New Memberships per Month',description:'Monthly membership creation volumes, broken down by the responsible employee.',category:_ReportCategory.management,icon:Icons.person_add_alt_1_outlined,usesDates:true),
    _ReportDefinition(key:'approval-requests-per-month',workcenterId:'management-approval-requests-per-month-report',title:'Approval Requests per Month',description:'Monthly approvals by request type with a requester drilldown.',category:_ReportCategory.management,icon:Icons.approval_outlined,usesDates:true),
    _ReportDefinition(key:'funeral-services-per-month',workcenterId:'management-funeral-services-per-month-report',title:'Funeral Services per Month',description:'Monthly funeral-service volumes, status and service value.',category:_ReportCategory.management,icon:Icons.calendar_month_outlined,usesDates:true),
    _ReportDefinition(key:'group-societies-total',workcenterId:'management-group-societies-total-report',title:'Total Group Societies',description:'Total and active Group Societies with aggregated balances.',category:_ReportCategory.management,icon:Icons.groups_outlined,usesDates:true),
    _ReportDefinition(key:'group-society-balances',workcenterId:'management-group-society-balances-report',title:'Group Society Balances',description:'List of Group Societies, individual balances and aggregate values.',category:_ReportCategory.management,icon:Icons.account_balance_wallet_outlined,usesDates:true),
    _ReportDefinition(key:'consolidated-customer-balances',workcenterId:'management-consolidated-customer-balances-report',title:'Consolidated Customer Balances',description:'Customer invoice, payment, credit and outstanding balance statement.',category:_ReportCategory.management,icon:Icons.receipt_long_outlined,usesDates:true),
  ];
